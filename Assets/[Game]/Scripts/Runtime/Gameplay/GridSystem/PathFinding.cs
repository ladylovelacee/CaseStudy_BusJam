...
namespace Runtime.Gameplay
{
    public class PathFinding : MonoBehaviour
    {
        ...
        public static NativeArray<int2> NeighbourOffsetArray;

        public static void Initialize()
        {
            if (NeighbourOffsetArray.IsCreated)
                NeighbourOffsetArray.Dispose(); // Eski bellek tahsis edilmiþse temizle

            NeighbourOffsetArray = new NativeArray<int2>(8, Allocator.Persistent);

            // Manuel olarak deðerleri ata
        ...
        {
            if (NeighbourOffsetArray.IsCreated)
                NeighbourOffsetArray.Dispose(); // Bellek sýzýntýsýný önlemek için Dispose çaðýr
        }
        ...
        private struct FindPathJob : IJob
        {
            ...
            public void Execute()
            {
                ...
                while (openList.Length > 0)
                {
                    ...
                    for (int i = 0; i < PathFinding.NeighbourOffsetArray.Length; i++)
                    {
                        int2 neighbourOffset = PathFinding.NeighbourOffsetArray[i];
